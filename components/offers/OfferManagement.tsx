              ...
              {offer.counterOffer && (
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4">
                  <div className="flex items-center space-x-2 mb-2">
                    ...
                    <p className="text-sm font-medium text-blue-900">Your Counter Offer</p>
                  </div>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      <p className="text-sm text-blue-700">Price: R{offer.counterOffer.price.toLocaleString()}/ton</p>
                    </div>
                    <div>
                      <p className="text-sm text-blue-700">Message: {offer.counterOffer.message}</p>
                    </div>
                  </div>
                </div>
              )}
